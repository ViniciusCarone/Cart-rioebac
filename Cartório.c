...
int consulta()
  {
	...
	{
		printf("\nEssas são as informações fo usuário: ");
		printf("%s",conteudo);
		printf("\n\n");
	}
...
int main ()       //int = função
{
	...
	for(laco=1;laco=1;)     //O for é "enquanto"
  {
	...
	printf ("### Cartório da EBAC ### \n\n"); //as # são cosméticas    //Inicio do menu
	printf ("Escolha a opção desejada do menu:\n\n");
	printf("\t1 - Registrar nomes\n"); // \t deixa um espaço antes de começar o texto escrito
	...
	registro();    // chama a variável registro
	break;         //acaba a linha 
